...
export const featuredCitiesMock: FeaturedCity[] = [
  {
    name: 'Roma',
    image:
      'https://images.unsplash.com/photo-1552832230-c0197dd311b5?auto=format&fit=crop&w=800&h=600',
    count: 87,
  },
  {
    name: 'Milano',
    image:
      'https://images.unsplash.com/photo-1543832923-44667a44c804?auto=format&fit=crop&w=800&h=600',
    count: 64,
  },
  {
    name: 'Firenze',
  ...
  },
  {
    name: 'Venezia',
    image:
      'https://images.unsplash.com/photo-1514890547357-a9ee288728e0?auto=format&fit=crop&w=800&h=600',
    count: 29,
  },
];
...
export const propertiesMock: Apartment[] = [
  {
    ...
    pricePeriods: [{ _type: 'priceRange', _key: 'p1', price: 120, currency: 'EUR' }],
  ...
  },
  {
    ...
    pricePeriods: [{ _type: 'priceRange', _key: 'p2', price: 150, currency: 'EUR' }],
    experienceCategory: { _ref: 'city-experience', _type: 'reference' },
  },
  {
    _id: 'apt3',
    ...
    pricePeriods: [{ _type: 'priceRange', _key: 'p3', price: 95, currency: 'EUR' }],
    experienceCategory: { _ref: 'city-experience', _type: 'reference' },
  },
  {
    _id: 'apt4',
    ...
    pricePeriods: [{ _type: 'priceRange', _key: 'p4', price: 110, currency: 'EUR' }],
  ...
  },
  {
    ...
    pricePeriods: [{ _type: 'priceRange', _key: 'p5', price: 180, currency: 'EUR' }],
  ...
  },
  {
    ...
    pricePeriods: [{ _type: 'priceRange', _key: 'p6', price: 90, currency: 'EUR' }],
