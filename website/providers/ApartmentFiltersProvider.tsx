...
const defaultFilters: FiltersState = { city: undefined, capacity: undefined, checkin: undefined, checkout: undefined };

export function ApartmentFiltersProvider({ children, initial }: { children: React.ReactNode; initial?: FiltersState; }) {
  ...
  return <ApartmentFiltersContext.Provider value={value}>{children}</ApartmentFiltersContext.Provider>;
}
